...
class sitemin_model_log {
    ...
    function insert($brr = array()) {
        ...
        $arr = $brr ? $brr : array('user_id' => $u['id'], 'router' => _url(), 'data' => json_encode(array('user' => $u, 'request' => xpAS::round_off($_REQUEST, 'password'), 'cookie' => $_COOKIE, 'server' => $_SERVER)),);
    ...
    function login24() {
        $arr = array('router' => 'logged in', "created >'" . xpDate::last_date(xpDate::timestamp()) . "'",);
