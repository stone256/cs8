...
class sitemin_model_crontab {
    ...
    function _time_map($date, $years = 10) {
        return array('weekday' => array(1, 7), 'minute' => array(0, 59), 'hour' => array(0, 23), 'date' => array(1, $date['mdays']), 'month' => array(1, 12), 'year' => array($date['year'], $date['year'] + $years), //will add manually here
